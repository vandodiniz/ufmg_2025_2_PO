...
A função objetivo, que busca minimizar o custo total de alocação (penalizando turnos noturnos), é:

$$
\text{Min } Z = \sum_{i=1}^{18} \sum_{j=1}^{4} c_j X_{ij}
$$
*Onde $c_j$ é o custo do turno $j$ ($c_j=1$ para diurnos e $c_j=2$ para noturnos).*
